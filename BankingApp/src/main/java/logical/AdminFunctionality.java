...
public class AdminFunctionality {
	...
	public long createNewAccount(int userId,double amount,String accountType,String ifscCode,String branchName)throws HelperException {
		AccountInfo account=new AccountInfo();
	...
	public boolean insertCustomerRecord(int userId,String pancard,Long aadhaar)throws HelperException{
		CustomerInfo customer=new CustomerInfo();
		customer.setUserId(userId);
